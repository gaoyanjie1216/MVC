...
import com.gyj.mvc.service.CourseService;
...
public class CourseController {
    ...
    public String doUploadFile(@RequestParam("file") MultipartFile file) throws IOException {
        ...
        if (!file.isEmpty()) {
            ...
            FileUtils.copyInputStreamToFile(file.getInputStream(), new File("d:\\gyj\\imooc\\", System.currentTimeMillis() + file.getOriginalFilename()));
        }
